        ...
        <main className="flex flex-col gap-10 px-6 pt-12 max-w-[1200px] mx-auto w-full pb-32">
            ...
            <section className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                <div className="relative order-2 lg:order-1 h-[400px] lg:h-[500px] rounded-[2rem] overflow-hidden shadow-neumorphic dark:shadow-neumorphic-sm-dark border border-white/60 dark:border-white/5 group bg-white dark:bg-[#1a1a1a] transition-colors">
                    ...
                    <img alt="Founder Avatar" className="absolute inset-0 w-full h-full object-cover object-top mix-blend-multiply dark:mix-blend-normal opacity-90 transition-transform duration-700 group-hover:scale-105" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDu9XEnFTFs3rov-2_MZILg_bqW-W1DIzkAnD2qaVPFZz5qdV3SNCKI57NyzScIclLh_msMHXeK4N-TU9ivYYb6P46gvLfHiWlEOCMUeGrKsBM8qbfPF-ay1VNHhyBb9uN_pWGg1W3MGDmCGaKMqO52lqkZgL7mkoPz1X3TYwbqkqosSeBJwVUiVNsT-PA5DqHCyWvxCNRJuGP4f0TCrDQBDe4yByGwc7pFUBfSk08lNOIcDvCmoYV_B9krLK4IsNMpkb9Nu20LY_c" />
